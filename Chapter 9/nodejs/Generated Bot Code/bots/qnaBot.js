...
class QnABot extends TeamsActivityHandler {
    ...
    constructor(conversationState, userState, dialog) {
        ...
        this.onTeamsChannelRenamedEvent(async (channelInfo, teamInfo, turnContext, next) => {
            await turnContext.sendActivity('You have renamed this channel! to.' + channelInfo.name);
        });
    }
}
